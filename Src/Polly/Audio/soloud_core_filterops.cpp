...
void Soloud::setFilterParameter(
    handle       aVoiceHandle,
...
void Soloud::fadeFilterParameter(
    handle       aVoiceHandle,
    unsigned int aFilterId,
    unsigned int aAttributeId,
    float        aTo,
...
void Soloud::oscillateFilterParameter(
    handle       aVoiceHandle,
    unsigned int aFilterId,
    unsigned int aAttributeId,
    float        aFrom,
    ...
    double       aTime)
{
    ...
    if (aVoiceHandle == 0)
    {
        ...
        if (mFilterInstance[aFilterId])
        {
            mFilterInstance[aFilterId]
                ->oscillateFilterParameter(aAttributeId, aFrom, aTo, aTime, mStreamTime);
        }
        unlockAudioMutex_internal();
        return;
    }
